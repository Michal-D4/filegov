...
class FilesCrt():
    ...
    def _scan_for_tags(self):
        ...
        ext_idx = FilesCrt._selected_db_indexes(self.ui.extList)
    ...
    def _dir_update(self):
        ...
        self._run_in_qthread(FilesCrt._finish_thread)
    ...
    def _save_path(index):
        path = FilesCrt.full_tree_path(index)
